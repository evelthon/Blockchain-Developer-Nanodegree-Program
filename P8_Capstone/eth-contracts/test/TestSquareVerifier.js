...
// Test verification with incorrect proof
  ...
  describe('verify correct and incorrect prood', function () {
    ...
    it('test verify correct proof', async function () {
      let result = this.contract.verifyTx.call(zokrates_proof.proof.A,
  ...
  const wrong_A =  '"A": ["0x2b87e1cbd2ee48394d90b659b779d612a4c515b98e277fab5db9d4f79231b224", "0x1c084306a472d225fc35f13aa4ef2688d25b218eaac067dee53eb561f4c504f2"]';
  it('test verify correct proof', async function () {
    let result = this.contract.verifyTx.call(wrong_A,
      zokrates_proof.proof.A_p,
      zokrates_proof.proof.B,
      zokrates_proof.proof.B_p,
      zokrates_proof.proof.C,
